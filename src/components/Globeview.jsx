...
const CITIES_URL = "https://raw.githubusercontent.com/datasets/world-cities/master/data/world-cities.geojson"; 
...
export default function GlobeView({ premium = false, onFallback, onUpgrade }) { 
  ...
  useEffect(() => { 
    ...
    .then(([ovationData, bordersGeoJson, citiesGeoJson]) => { 
      if (cancelled) return; 
      ...
      const majorCities = citiesGeoJson.features 
