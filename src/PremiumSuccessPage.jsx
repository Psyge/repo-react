 ...
 * PremiumSuccessPage
 * ============================================================
 * Aktivoi oston jälkeen palanneen käyttäjän premiumin ja näyttää
 * hälytysasetukset heti perään.
 *
 * HUOM: hälytysasetukset olivat aiemmin tässä tiedostossa omana
 * ~220-rivisenä komponenttinaan. Sama toteutus tarvitaan myös
 * /alerts-sivulla (AI-avustaja ohjaa sinne), joten se on siirretty
 * components/AuroraAlertsSetup.jsx:ään. Näin korjaus riittää tehdä
 * kerran — kahdessa paikassa ne olisivat väistämättä ajautuneet
 * erilleen.
 * ============================================================ */
...
export default function PremiumSuccessPage() {
  ...
  return (
    // Ei page-main-luokkaa: tällä sivulla ei ole Headeriä, joten headerin
    // korkeutta ei tarvitse ohittaa — oma padding riittää.
    <main
      className="container"
